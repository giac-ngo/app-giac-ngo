...
import ManualCoinTopUp from './ManualCoinTopUp';
                    ...
                    <table className="min-w-full divide-y divide-border-color">
                        <thead className="bg-background-light">
                            <tr>
                                ...
                                <th className="px-6 py-3 text-left text-xs font-medium text-text-light uppercase tracking-wider">{t.coins}</th>
...
const BillingManagement: React.FC<BillingManagementProps> = ({ user, language, onUserUpdate }) => {
    ...
    const handleTransactionSuccess = (updatedUser: User) => {
        ...
        // If the updated user is the currently logged-in admin, update their info
