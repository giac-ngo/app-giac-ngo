...
app.post('/api/chat/stream', async (req, res) => {
    const { aiConfig, messages, user, conversationId, isTestChat } = req.body;
    ...
    try {
        ...
        const onEnd = async (fullResponse) => {
            ...
            // Do not save test chats. Only save real conversations.
            if (!isTestChat) {
                if (conversationId) {
             ...
             // Coin deduction logic has been removed. Billing is based on active subscription.
